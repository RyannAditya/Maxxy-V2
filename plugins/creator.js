...
if (command == 'owner') {
 let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:WhatsApp;Saya Owner RyanBotz-V.3;Bot;;Md\nFN:Saya Owner RyanBotz-V.3 WhatsApp, Md\nNICKNAME:👑 RyanBotz-V.3\nORG:Ryann\nTITLE:soft\nitem1.TEL;waid=62822522851432:+62 822-5228-51432\nitem1.X-ABLabel:📞 Nomor Owner\nitem2.URL:https://chat.whatsapp.com/I47cTfEwzIC391KPBjbTPq\nitem2.X-ABLabel:💬 More\nitem3.EMAIL;type=INTERNET:muhammadryanadityapratama@gmail.com\nitem3.X-ABLabel:💌 Mail Owner RyanBotz-V.3\nitem4.ADR:;;🇮🇩 Indonesia;;;;\nitem4.X-ABADR:💬 More\nitem4.X-ABLabel:📍 Lokasi Saya\nBDAY;value=date:🔖 13 January 2001\nEND:VCARD`
...
if (command == 'creator') {
  ...
  const sentMsg = await conn.sendContactArray(m.chat, [
    [`${nomorown}`, `${await conn.getName(nomorown+'@s.whatsapp.net')}`, `👑 Developer Bot `, `🚫 Don't call me 🥺`, `muhammadryanadityapratama@gmail.com`, `🇮🇩 Indonesia`, `🚀 https://RyannAditya.github.io/`, `👤 Owner Gua Ganteng kok`],
    [`${conn.user.jid.split('@')[0]}`, `${await conn.getName(conn.user.jid)}`, `🔥 Bot WhatsApp 🐣`, `📵 Don't spam/call me 😢`, `Nothing`, `🇮🇩 Indonesia`, `🚀 https://chat.whatsapp.com/I47cTfEwzIC391KPBjbTPq`, `🤖 Hanya bot biasa yang kadang suka eror ☺`]
  ], fakes)
